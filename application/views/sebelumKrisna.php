...
<a href="<?= base_url(); ?>Penilaian/exportExcelAllData" class="btn btn-success"><i class="fas fa-file-excel fa-lg" style="margin-right:10px;"></i> Export Excel ALL DATA</a>
</div>
</div>
</div>
</div>
...
<div class="row mt-4">
  <div class="">
    <form method="POST" action="<?= base_url(); ?>Penilaian/SimpanData" id="formMainTabel">
  ...
  <div class="text-end mt-2">
      <button type="button" class="btn btn-dark" onclick="showCetakBa();"><i class="fas fa-download" style="margin-right:5px;"></i> DOWNLOAD BA</button>
...
<div class="modal modal-blur fade" id="modal_copyform" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    ...
    <div class="modal-body">
        <form id="formUploadFileDPA" action="<?= base_url(); ?>Penilaian/SimpanCopyForm" method="POST" enctype="multipart/form-data">
...
<div class="modal modal-blur fade" id="modal_ba" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    ...
    <div class="modal-body">
        <form id="formUploadFileDPA" action="<?= base_url(); ?>Penilaian/downloadPdf" method="POST">
...
<script type="text/javascript">
  ...
  sipanData = function () {
   ...
   if(validasiOK){
     ...
     ajaxUntukSemua(base_url()+'Penilaian/SimpanData', formData, function(data) {
...
showModalCopyForm = function (id) {
    ...
    ajaxUntukSemua(base_url()+'Penilaian/getDataAwalById', {id}, function(data) {
...
getDataTableConten = function () {
  ...
  ajaxUntukSemua(base_url()+'Penilaian/getDataKrisnaBelumSIap', {kdlokasi, kdkabkota, bidang}, function(data) {
...
${val.sts_copy != '2' ? `<button type="button" class="btn btn-icon btn-primary mt-2" onclick="showModalCopyForm(${val.id});" ${pfidPerkim != 'perkimpfid' ? 'disabled' : ''}><i class="fas fa-plus"></i></button>` : ''}</td>`;
tbody += `</tr>`;
...
$("#menu").change(function() {
  ...
  ajaxUntukSemua(base_url()+'Penilaian/getRincianByMenu', {val}, function(data) {
