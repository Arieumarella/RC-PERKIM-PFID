            ...
            <table class="tableContent">
                <thead class="thHeader">
                    <tr>
                        ...
                        <th class="adaDiHeaderdanBody">Komponen Sinkron</th>
                    </tr>
                </thead>
                <tbody class="bodyCss adaDiHeaderdanBody">
                    <?php $no=1; foreach ($dataTabel as $key => $value) { ?>
                        ...
                        <tr>
                            ...
                            <td class="adaDiHeaderdanBody" style="text-align: left;"><?= $value->komponen1; ?></td>
                            <td class="adaDiHeaderdanBody" style="text-align: left;"><?= $value->komponen2; ?></td>
                        </tr>
                        <?php $no++; ?>
                    <?php  } ?>
                    <!-- Tambahkan baris data lainnya sesuai kebutuhan -->
